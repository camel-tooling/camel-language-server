...
class CamelKModelineCamelPropertyFileTest extends AbstractCamelLanguageServerTest {
	...
	private CompletionItem createExpectedCompletionItem(String text) {
		...
		siblingCompletionItem.setTextEdit(Either.forLeft(new TextEdit(new Range(new Position(0, 25), new Position(0, 25)), text)));
	...
	private File createFileStructureForTest(String modelineToTest) throws IOException {
		...
		Files.writeString(camelKfile.toPath(), modelineToTest);
