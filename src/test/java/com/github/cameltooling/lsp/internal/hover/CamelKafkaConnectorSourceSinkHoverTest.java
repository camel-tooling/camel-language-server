...
class CamelKafkaConnectorSourceSinkHoverTest extends AbstractCamelKafkaConnectorTest {

	@Test
	void testHoverOnSinkProperty() throws Exception {
	...
	void testHoverOnSourceProperty() throws Exception {
		...
		assertThat(hover.get().getContents().getLeft().get(0).getLeft()).isEqualTo("Description of camel.source.path.aMediumPathOption");
	}
	
	@Test
	void testNoHoverWithUnknownConnectorClass() throws Exception {
