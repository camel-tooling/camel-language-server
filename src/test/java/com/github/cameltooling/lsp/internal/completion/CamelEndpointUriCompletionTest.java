...
public class CamelEndpointUriCompletionTest extends AbstractCamelLanguageServerTest {
    ...
    public static Stream<Arguments> data() {
    	return Stream.of(
    		...
    		arguments("<from uri=\"f\" xmlns=\"http://camel.apache.org/schema/blueprint\"></from>\n", 		0, 12, "URI with component scheme f", 		"f",	8, ".xml"),
    		arguments("<from uri=\"fi\" xmlns=\"http://camel.apache.org/schema/blueprint\"></from>\n", 		0, 13, "URI with component scheme fi",		"fi",	1, ".xml"),
    		arguments("<from uri=\"fil\" xmlns=\"http://camel.apache.org/schema/blueprint\"></from>\n", 	0, 14, "URI with component scheme fil", 	"fil",  1, ".xml"),
    		...
    		arguments("<from uri=\"ahc:ht\" xmlns=\"http://camel.apache.org/schema/blueprint\"></from>\n", 		0, 17, "URI with path param ht",	"ahc:ht",	1, ".xml"),
    		arguments("<from uri=\"ahc:htt\" xmlns=\"http://camel.apache.org/schema/blueprint\"></from>\n", 	0, 18, "URI with path param htt", 	"ahc:htt",	1, ".xml"),
    		arguments("<from uri=\"ahc:http\" xmlns=\"http://camel.apache.org/schema/blueprint\"></from>\n", 	0, 19, "URI with path param http", 	"ahc:http",	1, ".xml"),
    		arguments("<from uri=\"ahc:httpUri\" xmlns=\"http://camel.apache.org/schema/blueprint\"></from>\n", 0, 15, "URI with path param http", 	null,		1, ".xml"),
    		...
    		arguments("<from uri=\"file:bla?\" xmlns=\"http://camel.apache.org/schema/blueprint\"></from>\n", 		0, 20, "Empty option",			null,		70, ".xml"),
    		arguments("<from uri=\"file:bla?n\" xmlns=\"http://camel.apache.org/schema/blueprint\"></from>\n", 		0, 21, "URI with option n", 	"n",		1, ".xml"),
    		arguments("<from uri=\"file:bla?no\" xmlns=\"http://camel.apache.org/schema/blueprint\"></from>\n", 	0, 22, "URI with option no",	"no",		1, ".xml"),
    		arguments("<from uri=\"file:bla?noo\" xmlns=\"http://camel.apache.org/schema/blueprint\"></from>\n", 	0, 23, "URI with option noo", 	"noo",		1, ".xml"),
    		...
    		arguments("<from uri=\"file:bla?noop=f\" xmlns=\"http://camel.apache.org/schema/blueprint\"></from>\n", 0, 26, "URI with option noop", 	"f",	1, ".xml"),
    		arguments("from(\"file:bla?noop=f\")//camel", 															0, 21, "URI with option noop", 	"f",	1, ".java"),
    		arguments("<from uri=\"file:bla?noop=t\" xmlns=\"http://camel.apache.org/schema/blueprint\"></from>\n", 	0, 26, "URI with option noop", 	"t",	1, ".xml"),
    		...
    		arguments("<from uri=\"file:bla?noop=false\" xmlns=\"http://camel.apache.org/schema/blueprint\"/>\n",	0, 21, "Param Key Completion",	"n",		1, ".xml"),
